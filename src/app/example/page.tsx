...
const Example = () => {
    return (
        <>
            <motion.div className="h-[fit-content] relative w-full flex flex-col items-center overflow-hidden rounded-md bg-dot-slate-100/[0.24]">
                <div className="px-8 sm:px-0 mt-28 sm:mt-36 w-auto space-y-5">
